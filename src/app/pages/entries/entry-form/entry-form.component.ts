...
export class EntryFormComponent implements OnInit, AfterContentChecked {
  ...
  private createEntry() {
    const category: Entry = Object.assign(new Entry(), this.entryForm.value);

    this.entryService.create(category).subscribe(
  ...
  setPageTitle() {
    if (this.currentAction === 'new') {
      ...
      this.pageTitle = 'Editar Lançamento';
    }
  }
  ...
  private loadEntry() {
    if (this.currentAction === 'edit') {
      this.route.paramMap.pipe(
        ...
        (category) => {
          this.entry = category;
          this.entryForm.patchValue(category); // binds loaded entry data to entryForm
        },
